...
AppVeyor.prototype.triggerPullRequestBuild = function(prNumber, callback) {

};

AppVeyor.prototype.getRoles = function(callback) {
    this._client.request('roles', callback);
};
...
AppVeyor.prototype.getProjects = function(callback) {
    ...
    client.request('projects', function(err, payload) {
...
AppVeyor.prototype.getProjectLastBuild = function(slug, callback) {
    this._client.request('projects/' + this._accountName + '/' + slug, callback);
};
